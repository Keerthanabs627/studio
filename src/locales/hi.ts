...
export default {
  ...
  "my_fields": {
    "title": "मेरे खेत",
    "description": "विस्तृत क्षेत्र डेटा के आधार पर अपनी फसलों के लिए AI-संचालित सलाह प्राप्त करें।",
    "advice_error": "इस समय सलाह प्राप्त नहीं की जा सकी।",
    "card1": {
      "title": "खेत का डेटा",
      "description": "व्यक्तिगत सलाह प्राप्त करने के लिए अपने खेत का विवरण दर्ज करें।",
      "crop_label": "फसल का नाम",
