...
export default {
  ...
  "market_prices": {
    "title": "बाजार मूल्य",
    "description": "आपके स्थानीय बाजार से लाइव कमोडिटी की कीमतें (डेटा प्रदर्शन के लिए है)।",
    "table": {
  ...
  "my_fields": {
    "title": "मेरे खेत",
    "description": "हर स्तर पर अपनी फसलों के लिए AI-संचालित सलाह प्राप्त करें।",
    "advice_error": "इस समय सलाह प्राप्त नहीं की जा सकी।",
    "card1": {
      "title": "फसल विवरण",
      "description": "अपनी फसल और उसकी वर्तमान विकास अवस्था दर्ज करें।",
      "crop_label": "फसल का नाम",
    ...
    "card2": {
      "title": "प्रबंधन सलाह",
      "description_initial": "सलाह यहां दिखाई देगी।",
      "description_results": "यहां आपकी व्यक्तिगत सलाह है:",
      "initial_text": "प्रबंधन सलाह प्राप्त करने के लिए अपनी फसल का विवरण दर्ज करें।"
    }
  },
  "profile": {
