...
export default {
  ...
  dashboard: {
    ...
    farm_radio: {
        title: 'ఫార్మ్ రేడియో',
        description: 'మీ రోజు కోసం వ్యక్తిగతీకరించిన ఆడియో బ్రీఫింగ్ పొందండి.',
        play_button: 'రోజువారీ బ్రీఫింగ్ ప్లే చేయండి',
        pause_button: 'పాజ్',
        loading_button: 'జనరేట్ చేస్తోంది...',
        toast: {
            error_title: 'ప్రసారం విఫలమైంది',
        }
    },
    crop_doctor: {
        title: 'పంట వైద్యుడు',
  ...
  profile: {
    ...
    card2: {
      ...
      sms_description: 'ఎరువుల అప్లికేషన్ కోసం రిమైండర్‌లను స్వీకరించండి.',
    },
    toast: {
