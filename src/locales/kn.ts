...
export default {
  ...
  dashboard: {
    ...
    crop_doctor: {
      title: 'ಬೆಳೆ ವೈದ್ಯ',
      description: 'ಫೋಟೋ ಅಪ್‌ಲೋడ్ ಮಾಡುವ ಮೂಲಕ ಸಸ್ಯ ರೋಗಗಳನ್ನು ಪತ್ತೆ ಮಾಡಿ.',
  ...
  fertilizer_calculator: {
    ...
    card2: {
      ...
      stage: 'ಹಂತ',
      waste_alert_title: 'ವ್ಯర్థ ಉಳಿತಾಯ ಎಚ್ಚರಿಕೆ!',
  ...
  my_fields: {
    ...
    card1: {
      ...
      npk_label: 'ಎన్‌పಿಕೆ ಮಟ್ಟಗಳು (ಕೆಜಿ/ಹೆ)',
      button: 'ಸಲಹೆ ಪಡೆಯಿರಿ',
  ...
  guide: {
    ...
    step1_title: '1. ರೋಗನಿರ್ಣಯ మరియు ಗುರುತಿಸುವಿಕೆ',
    step1_desc: 'ಸಮಸ್ಯೆಯನ್ನು ಗುರುತಿಸುವ ಮೂಲಕ ಪ್ರಾರಂಭಿಸಿ. ನಿಮ್ಮ ಬೆಳೆ ಅನಾರೋಗ್ಯದಿಂದಿದೆಯೇ? AI-ಚಾಲಿತ ರೋಗನಿರ್ಣಯವನ್ನು ಪಡೆಯಲು ಕ್ರಾಪ್ ಡಾಕ್ಟರ್ ಬಳಸಿ మరియు ಚಿತ್ರವನ್ನು ಅಪ್‌ಲೋಡ್ ಮಾಡಿ.',
    ...
    step3_title: '3. ನಿರ್ವಹಣೆ మరియు ಕ್ರಮ',
    ...
    step4_title: '4. ಸಂಪರ್ಕ మరియు ಸಹಯೋಗ',
