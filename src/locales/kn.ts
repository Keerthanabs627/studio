...
export default {
  ...
  fertilizer_calculator: {
    title: 'ಸ್ಮಾರ್ಟ್ ಇಳುವರಿ ಆಪ್ಟಿಮೈಜರ್',
    description: 'ಇಳುವರಿಯನ್ನು ಹೆಚ್ಚಿಸಲು ಮತ್ತು ವ್ಯರ್ಥವನ್ನು ಕಡಿಮೆ ಮಾಡಲು ಕ್ರಿಯಾತ್ಮಕ, ಬಹು-ಹಂತದ ಯೋಜನೆಯನ್ನು ಪಡೆಯಿರಿ.',
    card1: {
    ...
    card2: {
      ...
      stage: 'ಹಂತ',
      waste_alert_title: 'ವ್ಯರ್ಥ ಉಳಿತಾಯ ಎಚ್ಚರಿಕೆ!',
  ...
  notifications: {
    ...
    card: {
      ...
      sms_description: 'ಪ್ರಮಾಣಿತ ಪಠ್ಯ ಸಂದేశಗಳ ಮೂಲಕ ಜ್ಞಾಪನೆಗಳನ್ನು ಸ್ವೀಕರಿಸಿ.',
  ...
  crop_doctor: {
    ...
    card2: {
      ...
      loading_description: "ನಮ್ಮ AI ನಿಮ್ಮ ಸಸ್ಯವನ್ನು ಪರಿಶೀಲಿಸುತ್ತಿದೆ. ಇದಕ್ಕೆ ಸ್ವಲ್ಪ ಸಮಯ લાગಬಹುದು.",
  ...
  guide: {
    title: 'ಅಪ್ಲಿಕೇಶನ್ ಮಾರ್ಗದರ್ಶಿ ಮತ್ತು ಫ್ಲೋಚಾರ್ಟ್',
    description: 'ಅಪ್ಲಿಕೇಶನ್‌ನ ಮುಖ್ಯ ಕೆಲಸದ ಹರಿವಿನ ದೃಶ್ಯ ಮಾರ್ಗದರ್ಶಿ.',
    step1_title: '1. ರೋಗನಿರ್ಣಯ ಮತ್ತು ಗುರುತಿಸುವಿಕೆ',
    step1_desc: 'ಸಮಸ್ಯೆಯನ್ನು ಗುರುತಿಸುವ ಮೂಲಕ ಪ್ರಾರಂಭಿಸಿ. ನಿಮ್ಮ ಬೆಳೆ ಅನಾರೋಗ್ಯದಿಂದಿದೆಯೇ? AI-ಚಾಲಿತ ರೋಗನಿರ್ಣಯವನ್ನು ಪಡೆಯಲು ಕ್ರಾಪ್ ಡಾಕ್ಟರ್ ಬಳಸಿ ಮತ್ತು ಚಿತ್ರವನ್ನು ಅಪ್‌ಲೋಡ್ ಮಾಡಿ.',
    step2_title: '2. ವಿಶ್ಲೇಷಣೆ ಮತ್ತು ಯೋಜನೆ',
    step2_desc: "ಒಮ್ಮೆ ನೀವು ಸಮಸ್ಯೆಯನ್ನು ತಿಳಿದುಕೊಂಡರೆ, ನಿಮ್ಮ ಪರಿಹಾರವನ್ನು ಯೋಜಿಸಿ. ಮಣ್ಣಿನ ಸೂಕ್ತತೆ ಪರೀಕ್ಷಕವನ್ನು ಬಳಸಿ, ಬಹು-ಹಂತದ ಗೊಬ್ಬರ ಯೋಜನೆಯನ್ನು ಪಡೆಯಿರಿ, ಅಥವಾ ತಿಳುವಳಿಕೆಯುಳ್ಳ ನಿರ್ಧಾರಗಳನ್ನು ತೆಗೆದುಕೊಳ್ಳಲು ಮಾರುಕಟ್ಟೆ ಬೆಲೆಗಳನ್ನು ಪರಿಶೀಲಿಸಿ.",
    step3_title: '3. ನಿರ್ವಹಣೆ ಮತ್ತು ಕ್ರಮ',
    step3_desc: "ನೀರಾವರಿ, ಪೋಷಕಾಂಶ ನಿರ್ವಹಣೆ ಮತ್ತು ಕೀಟ ನಿಯಂತ್ರಣದ ಕುರಿತು ವೈಯಕ್ತಿಕಗೊಳಿಸಿದ, ಕಾರ್ಯಸಾಧ್ಯವಾದ ಸಲಹೆಯನ್ನು ಪಡೆಯಲು ನನ್ನ ಹೊಲಗಳಿಗೆ ನಿಮ್ಮ ಕ್ಷೇತ್ರ ಡೇಟಾವನ್ನು ನಮೂದಿಸಿ. ಟ್ರ್ಯಾಕ್‌ನಲ್ಲಿ ಉಳಿಯಲು ಜ್ಞಾಪನೆಗಳನ್ನು ಹೊಂದಿಸಿ.",
    step4_title: '4. ಸಂಪರ್ಕ ಮತ್ತು ಸಹಯೋಗ',
    step4_desc: "ನೀವು ಒಬ್ಬಂಟಿಯಾಗಿಲ್ಲ. ಸಮುದಾಯ ಕೇಂದ್ರದಲ್ಲಿ ನಿಮ್ಮ ಸಂಶೋಧನೆಗಳನ್ನು ಹಂಚಿಕೊಳ್ಳಿ, ಕಾರ್ಮಿಕ ಮಾರುಕಟ್ಟೆಯಲ್ಲಿ ಸಹಾಯವನ್ನು ನೇಮಿಸಿಕೊಳ್ಳಿ, ಅಥವಾ AI ಚಾಟ್‌ಬಾಟ್‌ನಿಂದ ಯಾವುದೇ ಪ್ರಶ್ನೆಯನ್ನು ಕೇಳಿ.",
    app_flow: 'ಅಪ್ಲಿಕೇಶನ್ ಹರಿವು'
  },
  codes: {
    title: 'ಅಪ್ಲಿಕೇಶನ್ ಕೋಡ್',
    description: 'ಈ ಅಪ್ಲಿಕೇಶನ್‌ನಲ್ಲಿರುವ ಪ್ರತಿಯೊಂದು ಫೈಲ್‌ಗೆ ಸಂಪೂರ್ಣ ಮೂಲ ಕೋಡ್.'
  },
  crop_calendar: {
    title: "{month} ಗಾಗಿ ಬೆಳೆ ಕ್ಯಾಲೆಂಡರ್",
    subtitle: "{region} ಗಾಗಿ ಶಿಫಾರಸುಗಳನ್ನು ತೋರಿಸಲಾಗುತ್ತಿದೆ",
    description: "ಏನು ಬಿತ್ತನೆ ಮಾಡಬೇಕು, ಯಾವಾಗ ಕೊಯ್ಲು ಮಾಡಬೇಕು ಮತ್ತು ಯಾವ ಕೀಟಗಳ ಬಗ್ಗೆ ಎಚ್ಚರದಿಂದಿರಬೇಕು ಎಂಬುದರ ಕುರಿತು ಸಮಯೋಚಿತ ಸಲಹೆ ಪಡೆಯಿರಿ.",
    button: "ಕ್ಯಾಲೆಂಡರ್ ಪಡೆಯಿರಿ",
    sowing_title: "ಈ ತಿಂಗಳ ಬಿತ್ತನೆ",
    harvesting_title: "ಈ ತಿಂಗಳ ಕೊಯ್ಲು",
    alerts_title: "ಕೀಟ ಮತ್ತು ರೋಗ ಎಚ್ಚರಿಕೆಗಳು",
    affected_crops: "ಬಾಧಿತ ಬೆಳೆಗಳು",
    symptoms: "ರೋಗಲಕ್ಷಣಗಳು",
    prevention: "ತಡೆಗಟ್ಟುವಿಕೆ",
    no_data: "ಈ ಸಮಯದಲ್ಲಿ ಕ್ಯಾಲೆండರ್ ಡೇಟಾವನ್ನು ಲೋಡ್ ಮಾಡಲು ಸಾಧ್ಯವಾಗಲಿಲ್ಲ.",
    toast: {
      error_title: "ಕ್ಯಾಲೆಂಡರ್ ಲೋಡ್ ಮಾಡಲು ವಿಫಲವಾಗಿದೆ",
      error_desc: "ಕ್ಯಾಲೆಂಡರ್ ಡೇಟಾವನ್ನು ಹಿಂಪಡೆಯಲು ಸಾಧ್ಯವಾಗಲಿಲ್ಲ. ದಯವಿಟ್ಟು ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಿ."
    }
  }
} as const;
