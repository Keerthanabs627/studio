...
import { Bot, Calculator, LayoutDashboard, LineChart, Users, Map, Tractor, Bell, MessageCircle, Stethoscope, Radio, Landmark, Wrench, Compass, Code, User, CalendarDays } from 'lucide-react';
